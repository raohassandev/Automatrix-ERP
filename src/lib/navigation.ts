...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "AP Aging", href: "/reports/ap", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
    ],
  },
  {
    title: "People",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Trial Balance", href: "/reports/accounting/trial-balance", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Cash Position", href: "/reports/accounting/cash-position", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Cash Forecast", href: "/reports/accounting/cash-forecast", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Bank Reconciliation", href: "/reports/accounting/bank-reconciliation", icon: FileBarChart, permissions: ["company_accounts.manage", "accounting.manage", "reports.view_all"] },
      { name: "AR Aging", href: "/reports/accounting/ar-aging", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "O2C Reconciliation", href: "/reports/accounting/o2c-reconciliation", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Profit & Loss", href: "/reports/accounting/profit-loss", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Balance Sheet", href: "/reports/accounting/balance-sheet", icon: FileBarChart, permissions: ["accounting.view", "reports.view_all"] },
      { name: "Procurement Report", href: "/reports/procurement", icon: FileBarChart, permissions: ["procurement.view_all", "reports.view_all", "reports.view_team"] },
      { name: "Inventory Report", href: "/reports/inventory", icon: FileBarChart, permissions: ["inventory.view", "reports.view_all", "reports.view_team"] },
      { name: "Project Reports", href: "/reports/projects", icon: FileBarChart, permissions: ["projects.view_financials", "projects.view_all", "reports.view_all", "reports.view_team"] },
      { name: "Exceptions Report", href: "/reports/exceptions", icon: FileBarChart, permissions: ["audit.view", "reports.view_all"] },
    ],
  },
  {
    title: "Directory",
